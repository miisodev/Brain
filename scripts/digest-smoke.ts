/**
 * scripts/digest-smoke.ts — print the start_session orientation digest
...
const parsed = JSON.parse(readFileSync(join(here, "..", "dist", "brain.json"), "utf-8"));
const cfg: BrainConfig = { ...parsed, policy: { ...DEFAULT_POLICY, ...(parsed.policy ?? {}) } };
